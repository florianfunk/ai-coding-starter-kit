...
function PreviewInner({ produktId }: { produktId: string }) {
  ...
  const iframeSrc = `/produkte/${produktId}/datenblatt/raw?layout=${layout}`;
  ...
  return (
    <div className="flex flex-col gap-3 flex-1 min-h-0">
      ...
      <div className="flex items-center gap-1.5 flex-wrap shrink-0">
        ...
        >
          <a
            href={`/produkte/${produktId}/datenblatt?layout=${layout}`}
            target="_blank"
      ...
      <Button variant="outline" asChild className="w-full shrink-0">
        <a
          href={`/produkte/${produktId}/datenblatt/raw?layout=${layout}&download=1`}
        >
