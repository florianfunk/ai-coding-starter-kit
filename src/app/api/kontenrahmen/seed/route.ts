...
const STANDARD_KONTENRAHMEN: SeedKategorie[] = [
  ...
  {
    bezeichnung: "Bewirtung / Spesen (70% abziehbar)",
    typ: "ausgabe",
    ust_satz: 19,
    euer_zeile: "Anlage EÜR Z. 67 – Bewirtungskosten (70%)",
    elster_kennzahl: "66",
  },
  {
    bezeichnung: "Fortbildung / Schulungen",
    typ: "ausgabe",
    ust_satz: 19,
    euer_zeile: "Anlage EÜR Z. 51 – sonstige unbeschränkt abziehbare BA",
    elster_kennzahl: "66",
  ...
  {
    bezeichnung: "Werbung / Marketing",
    typ: "ausgabe",
    ust_satz: 19,
    euer_zeile: "Anlage EÜR Z. 49 – Werbe- und Reisekosten",
    elster_kennzahl: "66",
  },
  {
    bezeichnung: "Rechts- / Beratungs- / Steuerberatungskosten",
    typ: "ausgabe",
    ust_satz: 19,
    euer_zeile: "Anlage EÜR Z. 47 – Rechts- u. Beratungskosten",
    elster_kennzahl: "66",
  },
  {
    bezeichnung: "Porto / Versandkosten",
    typ: "ausgabe",
    ust_satz: 19,
    euer_zeile: "Anlage EÜR Z. 48 – Kommunikationskosten",
    elster_kennzahl: "66",
  ...
  {
    bezeichnung: "Software / IT / Cloud-Dienste",
    typ: "ausgabe",
    ust_satz: 19,
    euer_zeile: "Anlage EÜR Z. 51 – sonstige unbeschränkt abziehbare BA",
    elster_kennzahl: "66",
  ...
  {
    bezeichnung: "Reparatur / Wartung / Instandhaltung",
    typ: "ausgabe",
    ust_satz: 19,
    euer_zeile: "Anlage EÜR Z. 42 – Reparatur/Instandhaltung",
    elster_kennzahl: "66",
  },
  {
    bezeichnung: "Geringwertige Wirtschaftsgüter (GWG, bis 800€)",
    typ: "ausgabe",
    ust_satz: 19,
    euer_zeile: "Anlage EÜR Z. 33 – GWG bis 800 €",
    elster_kennzahl: "66",
  },
  {
    bezeichnung: "Bankgebühren / Kontoführung",
    typ: "ausgabe",
    ust_satz: 0,
    euer_zeile: "Anlage EÜR Z. 51 – sonstige unbeschränkt abziehbare BA",
    elster_kennzahl: null,
  ...
  {
    bezeichnung: "Beiträge / Mitgliedschaften (geschäftlich)",
    typ: "ausgabe",
    ust_satz: 0,
  ...
  // ----- Privat (kein Vorsteuerabzug, keine EÜR-Wirkung) -----
  // Feinere Klassifizierung privater Ausgaben für Auswertung &
  // Einkommensteuer-Anlage Vorsorgeaufwand / Sonderausgaben (PROJ-10).
  {
    bezeichnung: "Privat: Lebensmittel / Supermarkt",
    typ: "privat",
    ust_satz: null,
  ...
  {
    bezeichnung: "Privat: Restaurant / Gastronomie",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – keine EÜR-Auswirkung",
    elster_kennzahl: null,
  ...
  {
    bezeichnung: "Privat: Kleidung / Schuhe",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – keine EÜR-Auswirkung",
    elster_kennzahl: null,
  ...
  {
    bezeichnung: "Privat: Wohnen / Miete / Nebenkosten",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – keine EÜR-Auswirkung",
    elster_kennzahl: null,
  ...
  {
    bezeichnung: "Privat: Strom / Gas / Wasser",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – keine EÜR-Auswirkung",
    elster_kennzahl: null,
  ...
  {
    bezeichnung: "Privat: Krankenversicherung (Sonderausgabe)",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Sonderausgaben – Anlage Vorsorgeaufwand",
    elster_kennzahl: null,
  },
  {
    bezeichnung: "Privat: Sonstige Versicherungen (KFZ-Haftpflicht etc.)",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – keine EÜR-Auswirkung",
    elster_kennzahl: null,
  ...
  {
    bezeichnung: "Privat: Altersvorsorge / Rente (Sonderausgabe)",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Sonderausgaben – Anlage Vorsorgeaufwand",
    elster_kennzahl: null,
  ...
  {
    bezeichnung: "Privat: Telekommunikation (Mobilfunk/Internet privat)",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – keine EÜR-Auswirkung",
    elster_kennzahl: null,
  ...
  {
    bezeichnung: "Privat: Mobilität (ÖPNV/Taxi/Tanken privat)",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – keine EÜR-Auswirkung",
    elster_kennzahl: null,
  ...
  {
    bezeichnung: "Privat: Gesundheit / Apotheke / Arzt",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – ggf. außergewöhnliche Belastung",
    elster_kennzahl: null,
  },
  {
    bezeichnung: "Privat: Freizeit / Unterhaltung / Streaming",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – keine EÜR-Auswirkung",
    elster_kennzahl: null,
  ...
  {
    bezeichnung: "Privat: Bildung / Schule / Kita",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – ggf. Kinderbetreuungskosten (Sonderausgabe)",
    elster_kennzahl: null,
  },
  {
    bezeichnung: "Privat: Geschenke",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – keine EÜR-Auswirkung",
    elster_kennzahl: null,
  ...
  {
    bezeichnung: "Privat: Spenden (Sonderausgabe)",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Sonderausgaben – Spendenabzug",
    elster_kennzahl: null,
  },
  {
    bezeichnung: "Privat: Familie / Unterhalt",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – ggf. Unterhalt (Sonderausgabe)",
    elster_kennzahl: null,
  },
  {
    bezeichnung: "Privat: Sparen / Geldanlage",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – keine EÜR-Auswirkung",
    elster_kennzahl: null,
  ...
  {
    bezeichnung: "Privat: Sonstige Ausgaben",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – keine EÜR-Auswirkung",
    elster_kennzahl: null,
  ...
  {
    bezeichnung: "Privatentnahme (Barabhebung / Übertrag privat)",
    typ: "privat",
    ust_satz: null,
    euer_zeile: "Privatsphäre – keine EÜR-Auswirkung",
    elster_kennzahl: null,
